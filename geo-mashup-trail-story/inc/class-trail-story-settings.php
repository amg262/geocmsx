                            ...
                            <fieldset>
                                ...
                                <label for="trail_story_options[<?php echo $key; ?>]">
                                    ...
                                    <select id='trail_story_options[<?php echo $key; ?>]'
                                        ...
                                        <option
                                            value="Pale Dawn" <?php selected($trail_story_options[$key], 'Pale Dawn'); ?>>
                                            Pale Dawn
                                        </option>
                                        <option
                                        ...
                                        <option
                                            value="Avocado" <?php selected($trail_story_options[$key], 'Avocado'); ?>>
                                            Avocado
                                        </option>
                                        <option value="Hopper" <?php selected($trail_story_options[$key], 'Hopper'); ?>>
                                            Hopper
                                        </option>
                                        <option value="Custom" <?php selected($trail_story_options[$key], 'Custom'); ?>>
                                            Custom
                                        </option>
                                    </select>
                                </label>
