                    ...
                    <td>
                        ...
                        <fieldset><?php $key = 'gsx_license';
                            ...
                            <label for="trail_story_options[<?php echo $key; ?>]">
                                <input style="width:320px;" id='trail_story_options[<?php echo $key; ?>]'
                                       name="trail_story_options[<?php echo $key; ?>]" type="text"
                    ...
                    <fieldset>
                        ...
                        <label for="trail_story_options[<?php echo $key; ?>]">
                            ...
                            <select id='trail_story_options[<?php echo $key; ?>]'
                                ...
                                <option
                                    value="Subtle Grayscale" <?php selected($trail_story_options[$key], 'Subtle Grayscale'); ?>>
                                    Subtle Grayscale
                                </option>
                                <option
                                    value="Unsaturated Browns" <?php selected($trail_story_options[$key], 'Unsaturated Browns'); ?>>
                                    Unsaturated Browns
                                </option>
                                <option value="Paper" <?php selected($trail_story_options[$key], 'Paper'); ?>>Paper
                                </option>
                                <option value="Pale Dawn" <?php selected($trail_story_options[$key], 'Pale Dawn'); ?>>
                                    Pale Dawn
                                </option>
                                <option
                                    value="Midnight Commander" <?php selected($trail_story_options[$key], 'Midnight Commander'); ?>>
                                    Midnight Commander
                                </option>
                                <option value="Retro" <?php selected($trail_story_options[$key], 'Retro'); ?>>Retro
                                </option>
                                <option value="Bright" <?php selected($trail_story_options[$key], 'Bright'); ?>>Bright
                                </option>
                                <option value="Avocado" <?php selected($trail_story_options[$key], 'Avocado'); ?>>
                                    Avocado
                                </option>
                                <option value="Hopper" <?php selected($trail_story_options[$key], 'Hopper'); ?>>Hopper
                                </option>
                                <option value="Custom" <?php selected($trail_story_options[$key], 'Custom'); ?>>Custom
                                </option>
                            </select>
                        </label>
                        <p class="description"></p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <fieldset><?php $key = 'custom_map_style';
                        //var_dump($trail_story_options[$key]);?>
                        <label for="trail_story_options[<?php echo $key; ?>]">
                            <textarea rows="5" style="width:700px;" name="trail_story_options[<?php echo $key; ?>]"
                                      id="trail_story_options[<?php echo $key; ?>]"
                                      value="<?php echo $trail_story_options[$key]; ?>"><?php echo $trail_story_options[$key]; ?></textarea>

                        </label>
                    </fieldset>
                    <p class="description">
                        Custom map style creator available at <a href="http://snazzymaps.com" target="_blank">Snazzy
                            Maps</a></p>
