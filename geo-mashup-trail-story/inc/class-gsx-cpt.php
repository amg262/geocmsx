...
>>>>>>> d9aaa0541812c3ba76d71b1a35f90353b502266e
    /**
     * Taxonomy for GeoPost CPT categories
     */
<<<<<<< HEAD
...
=======
    public function save( $post_id ) {
        ...
        update_post_meta( $post_id, 'geocms_field', $mydata );
    }
    ...
    public function render_meta_box_content( $post ) {
        ...
        $value = get_post_meta( $post->ID, 'geocms_field', true );

        // Display the form, using the current value.
        ?>
        <label for="new_geocms_field">
            <h4><?php _e( 'Coordinates', 'textdomain' ); ?></h4>
        </label>
        <input type="text" id="new_geocms_field" name="new_geocms_field" value="<?php echo esc_attr( $value ); ?>" style="width:50%;" />
        <?php
>>>>>>> d9aaa0541812c3ba76d71b1a35f90353b502266e
    }
